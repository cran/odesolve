clll. optimize
      subroutine prja (neq, y,yh,nyh, ewt, ftem, savf, wm, iwm, f, jac)

      implicit none
C Arguments 
      external f, jac
      integer neq(1), nyh, iwm(21)
      double precision y(1), yh(nyh,2), ewt(1), ftem(1), savf(1), wm(3)
c The dimensions really *are* larger, e.g. wm(n + 2),  iwm(21 + n (- 1))  [?]
