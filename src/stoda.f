      subroutine stoda (neq, y, yh, nyh, yh1, ewt, savf, acor, wm, iwm,
     1     f, jac, pjac, slvs)
clll. optimize
      implicit none
C Arguments
      external f, jac, pjac, slvs
      integer neq(1), nyh, iwm(1)
      double precision y(1), yh(nyh,2), yh1(1), 
     +     ewt(1), savf(1), acor(1), wm(1)
c     The dimensions really *are* larger, ....
